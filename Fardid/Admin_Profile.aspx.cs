    ...
    public partial class Admin_Profile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack) {
                ...
                HiddenField_Profile.Value = model.ProfilePic_Id.ToString();
                Image1.ImageUrl = model.ProfilePic_Path;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if(TextBox_Email.Text!="" && TextBox_Family.Text != "" &&TextBox_Namle.Text != "" &&TextBox_Phone.Text != "")
            {
                ...
                model1.ProfilePic_Id = Convert.ToInt32(HiddenField_Profile.Value);
