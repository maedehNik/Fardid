...
namespace DB_Connect
{
    public class PDBC
    {
        ...
        public PDBC()
        {
            ...
            //reader.Close();
            _ConnectionString = "Data Source=.;Initial Catalog=Fardid;Integrated Security=True";
            connection = new SqlConnection(_ConnectionString);//User ID=sa;Password=shahab75;
        }
